...
| [`sandbox-isolation-test.md`](sandbox-isolation-test.md) | Разовая проверка изоляции агента Claude Code: выход за папку проекта встроенными инструментами и через MCP, с дословной фиксацией отказов классификатора (пробные файлы вне проекта удалены) |
